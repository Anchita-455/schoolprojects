...
# author: Anchita Dash
# CSE 30
# Implementation of Graph.py and Vertex.py classes (from CSE 30 google colab)
...
class Vertex:
    ...
    # adds the vertex (nbr) to the list of connections
    ...
    # returns all the memory locations of vertices it is connected to
